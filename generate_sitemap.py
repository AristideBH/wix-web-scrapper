...
async def get_url_from_clickable_element(page, selector, max_retries=2):
...
async def crawl_wix_site(page, base_url):
    ...
    spinner_thread = threading.Thread(target=spinner_with_url)
...
if __name__ == "__main__":
    wix_url = "https://ogenuite.wixsite.com/goo-studio/decoration"
